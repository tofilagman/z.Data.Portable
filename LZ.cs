...
namespace z.Data
{
    public sealed class LZ
    {
        ...
        string keyStrBase64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
        string keyStrUriSafe = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$";
        ...
        private GetCharFromInt f = (a) => Convert.ToChar(a);
